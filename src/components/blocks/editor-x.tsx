...
export function Editor({
  ...
  return (
    <div className="bg-bg overflow-hidden rounded-lg border shadow w-full h-full flex flex-col min-h-0">
      <LexicalExtensionComposer extension={AppExtension} contentEditable={null}>
        <div className="relative flex flex-1 flex-col min-h-0">
          ...
          <div className="relative flex flex-1 flex-col min-h-0">
            <div ref={onRef} className="relative flex-1 min-h-0">
              <ContentEditable
          ...
          <ActionsPlugin>
            <div className="clear-both flex flex-wrap items-center justify-between gap-2 border-t p-1 shrink-0">
              <div className="flex flex-1 justify-start text-xs text-muted-fg">
